...
# E.g. Rscript ./scripts/extract_sedol.r sedol
################################################################################
################################################################################
# Args
################################################################################
# Takes one argument: name of the file to extract data from with no file 
# extension. 
# The file name must refer to an Excel (xlsx) file that lives in the data folder
