...
stats_availables <- modules::use(paths$path_stats_availables_component)
...
ui <- function(id) {
  ...
  shinydashboard::dashboardBody(
    shinydashboard::tabItems(
      ...
      shinydashboard::tabItem(tabName = "stats-availables", stats_availables$ui(ns("stats-availables")))
    )
  )
}
...
server <- function(id) {
  shiny::moduleServer(id, function(input, output, session) {
    ...
    stats_availables$server("stats-availables")
  })
}
