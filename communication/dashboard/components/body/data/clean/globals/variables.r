...
excluded from the book dataset while the full time series of prices, returns and 
events for the corresponding firms are excluded from the prices, returns and events 
datasets below.
")
...
modules::export("caption_prices")
caption_prices <- "Source file: 'AGMdata.dta'"
