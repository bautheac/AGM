...
modules::export("book_variables")
book_variables <- names(raw_to_clean_book_variable_names_map)

modules::export("raw_to_clean_book_other_names_map")
raw_to_clean_book_other_names_map <- c(
  "number"                                    = "No",
  "company name"                              = "CoName",
  "id"                                        = "ID",
  "full year"                                 = "Full year",
