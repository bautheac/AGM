...
formatted_date_typos <- tibble::tribble(
  ...
  "first day of closed books",      "id == 'BA016' & `date of reporting period end` == '1913-12-31'",  "1914-01-23",
  "first day of closed books",      "id == 'OT010' & `date of reporting period end` == '1913-12-31'",  "1914-02-28",
  "first day of closed books",      "id == 'OT016' & `date of reporting period end` == '1911-04-12'",  "1911-05-29",
  "first day of closed books",      "id == 'OT029' & `date of reporting period end` == '1914-06-30'",  "1915-01-04",
  "first day of closed books",      "id == 'RL001' & `date of reporting period end` == '1910-12-31'",  "1911-03-18",
  "first day of closed books",      "id == 'RL007' & `date of reporting period end` == '1910-12-31'",  "1911-02-03",
  "first day of closed books",      "id == 'RL034' & `date of reporting period end` == '1910-06-30'",  "1910-07-25",
  "first day of closed books",      "id == 'RL064' & `date of reporting period end` == '1914-03-30'",  "1914-12-31",
  "first day of closed books",      "id == 'RL069' & `date of reporting period end` == '1913-06-30'",  "1913-10-22",
