...
correct_unformated_date_typos <- function(book_data){
  dplyr::mutate(
    book_data, 
...
correct_formated_date_typos <- function(book_data){
  dplyr::mutate(
    book_data, 
...
clean_date_columns <- function(book_data){
  ...
  correct_unformated_date_typos(book_data) |>
    format_dates(convert_to_standard_date_format_from_excel) |>
    correct_formated_date_typos()
}