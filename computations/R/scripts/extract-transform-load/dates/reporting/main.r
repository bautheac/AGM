...
path_dates_data_transformer <- 
  here::here("computations", "R", "scripts", "extract-transform-load", "dates", "reporting", "transformer", "main.r")
...
path_globals <- here::here("computations", "R", "scripts", "extract-transform-load", "dates", "reporting", "globals.r")
...
data_loader$load_objects(
  ...
  list(globals$filepath_clean_dates_reporting_main, globals$filepath_clean_dates_reporting_dashboard)
)
