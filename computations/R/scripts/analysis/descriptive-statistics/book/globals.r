...
path_book_descriptive_stats_results <- 
  here::here(descriptive_stats_paths$path_descriptive_stats_results_directory, "book", "statistics-by-reporting-frequency.rds")

modules::export("path_book_descriptive_stats_dashboard")
path_book_descriptive_stats_dashboard <- 
  here::here(descriptive_stats_paths$path_descriptive_stats_dashboard_directory, "book", "statistics-by-reporting-frequency.rds")
