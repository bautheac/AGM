...
data_loader$load_objects(
  ...
  list(
    list(globals$path_returns_firms_descriptive_stats_results, globals$path_returns_firms_descriptive_stats_dashboard),
    list(globals$path_returns_aggregate_descriptive_stats_results, globals$path_returns_aggregate_descriptive_stats_dashboard)
    )
)
